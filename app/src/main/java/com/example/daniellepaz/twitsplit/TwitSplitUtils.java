...
public class TwitSplitUtils {
    ...
    private static String ERROR_NOWHITESPACE = "ERROR_NOWHITESPACE";
    ...
    private static List<String> splitTweets(String tweet) {
        ...
        if (tweet.length() == 50  || tweet.length() < 50) {
            ...
            if (!tweet.contains((" "))) {
                ...
                while (index < tweet.length()) {
                    ...
                    if (holder.endsWith(" ")) {
                        ...
                        //System.out.println("added to array: " +  holder.substring(0, holder.length()-1));
                        ...
                        index += spaceForMessage;
                        //System.out.println("added to array: " +  holder);
                    } else {
                        int i;
                        ...
                        //System.out.println("holder: " + holder);
                        splitTweet.add(holder);
                        //System.out.println("added to array: " +  holder.substring(0, holder.length()) + ", Length: " + holder.substring(0, holder.length()).length());
                        index += i + 1;
                        //System.out.println("index: " + index);
                    }
                }
